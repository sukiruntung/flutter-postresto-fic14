...
mixin _$CheckoutState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<ProductQty> items) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProductQty> items)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ProductQty> items});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<ProductQty> items) : _items = items;

  final List<ProductQty> _items;
  @override
  List<ProductQty> get items {
...
abstract class _Loaded implements CheckoutState {
  const factory _Loaded(final List<ProductQty> items) = _$LoadedImpl;
